<?
define('DATE_PICKER_WS_PATH', SITE_URL_PATH.'/'.PLUGINS_DIR.'/date_picker');
...
function get_date_picker1($jscal_input_name, $jscal_def_date='', $validation = 'date|dd/mm/yyyy|-', $validation_msg = 'Date should be in dd-mm-yyyy format')
{
	$date_picker = date_picker_includes();
	ob_start();
	include(dirname(__FILE__).'/date_pick1.inc.php');
	$date_picker .= ob_get_contents();
	ob_end_clean();
	return $date_picker;
}
